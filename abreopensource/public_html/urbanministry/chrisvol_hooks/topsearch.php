...
<input type="text" maxlength="255" name="keys" id="edit-keys"  size="60" value="" class="form-text" /> <input type="submit" name="op" id="edit-submit" value="Search"  class="form-submit" /><input type="hidden" name="form_token" id="edit-search-form-form-token" value="<?php print drupal_get_token('search_form'); ?>" /><input type="hidden" name="form_id" id="edit-search-form" value="search_form"  />
...
<form action="/search/user"  method="post" id="search-form" class="search-form">
