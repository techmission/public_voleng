...
<div class="form-item"><label for="edit-email">Email Address: </label> <input type="text" style="font-style:normal;" id="edit-email" size="18" maxlength="128" name="email" /></div>
