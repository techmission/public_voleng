...
<div id="body">
 	<center><h3>  
 	  <br>
 	  <fieldset style="width: 508px; height: 370px">
 	  <br><br>
      <i>We're sorry, there are no results for your search.</i>
      <br><br><hr width=75%><br>
	  <i>To refine your search, click </i> <a href="<%=aszPortal%>/personalitytest.jsp">here</a><i> to change your interests,</i>
      <br><br>
      . . . or try another search below:
      <br><br>
...
<input type="hidden" value="" name="postype"/>


<%
String aszDisplayRequestType="";
try{if(aszReferer.contains("churchopportunities.jsp")	||
	...
	aszDisplayRequestType="myResultsAdminSelect";
}
}catch(Exception e){}
if(aszDisplayRequestType.equals("myResultsAdminSelect")){
%>
...
<div id="postallabeloppLocal"><strong>Postal Code</strong></div>
      </td><td style="width: 80px;"><div id="postaloppLocal"><input type="text" size="20" style="width: 60px;" id="postalcodeoppsrchnone" name="postalcode"/></div>
</td>
</tr>
<tr><td align="right">
<strong>Service Area</strong>
</td><td colspan="2">
				<SELECT id="servicearea1oppsrchnone" name="servicearea1" size="1" class="smalldropdown" > 
...
<strong>Skills</strong>
        ...
        <select id="skills1idoppsrchnone" name="skills1id" class="smalldropdown" >
...
<strong id="countrylabelopp">Country</strong></td><td colspan="2">
	...
	<SELECT id="countryoppsrchnone" name="country" size="1" style="z-index: 0;" class="smalldropdown">
	 <OPTION value=""></OPTION>
		<%
		aszTemp= "US";
		...
		%>
         ...
         <td align="left" colspan="2">
			<input type="checkbox" value="<%=aszGroupTID%>" name="greatforgroup" id="greatforgroupoppsrchnone" />
            &nbsp;Group 
            <input type="checkbox" value="<%=aszFamilyTID%>" name="greatforfamily" id="greatforfamilyoppsrchnone"/>
        	&nbsp;Family
            <input type="checkbox" value="<%=aszKidTID%>" name="greatforkid" id="greatforkidoppsrchnone"/>
        	&nbsp;Kid
            <input type="checkbox" value="<%=aszTeenTID%>" name="greatforteen" id="greatforteenoppsrchnone"/>
            &nbsp;Teen 
            <input type="checkbox" value="<%=aszSeniorTID%>" name="greatforsenior" id="greatforsenioroppsrchnone"/>
            &nbsp;Senior 

</td>
</tr>
<tr><td width="100"></td><td colspan="2">
<input type="checkbox" value="<%=aszYesWorkStudyTID%>" name="workstudy" id="workstudyoppsrchnone" />Search for Work Study Volunteer Opportunities
<br/><input type="checkbox" styleClass="check" value="4795" id="virt_voloppsrchnone" name="postype" onclick="toggle(this, 'country', 'postalcode')" />Search <span style="color: rgb(47, 85, 131); cursor: help;" title="Volunteers who share their skills remotely" onmouseover="this.style.cursor="help";">Virtual</span> Volunteer Opportunities
</td></tr>
		 <tr><td align="right">
</td><td>
<% if(aszDisplayRequestType.equals("myResultsAdminSelect")){ %>
<button type="button" id="submitButton" onclick="oppsrchnone_search()">Search</button>
<% }else{ %>
