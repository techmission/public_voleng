...
<script type="text/javascript" src="<%=request.getContextPath()%>/template_include/js/ajax-solr/helpers/ajaxsolr.support.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/template_include/js/ajax-solr/helpers/ajaxsolr.theme.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/template_include/js/ajax-solr/widgets/MapResultsWidget.js"></script>
...
<!--br clear="all"/-->
	<div id="nav">
		<ul id="pager"></ul>  <ul id="pager-header"></ul>  <ul id="map_link">Map these results</ul>
	</div>
	<br clear="all">
