...
<br>
<b>PLEASE NOTE:</b> If you are the contact for an organization, fill out this form. 
...
<html:hidden property="signature" value="<%=Signature%>" />
...
<% if(userprofile.getUSPNameFirst().length() > 2 ){ %>
<html:hidden property="namefirst" value="<%=userprofile.getUSPNameFirst()%>" />
<% }		if(userprofile.getUSPNameLast().length() > 2 ){ %>
...
document.write("<input type=\"hidden\" id=\"timezone\" name=\"timezone\"  value=\" " + gmtHours + " \">");
	...
	<table width="80%" border="0" cellpadding="0" cellspacing="0" id="splash" align="center" >
		...
		<tr>
                ...
                <TD>
                <bean:write name="individualForm" property="username"/>
		...
		<tr>
        		<TD ><b>Email</b></TD>
                <TD>
                <bean:write name="individualForm" property="email1addr"/>
		...
		<tr>
                ...
                <TD  height="23">
                <% if(userprofile.getUSPNameFirst().length() > 2 ){ %>
                	<bean:write name="individualForm" property="namefirst"/>
                <% }else{ %>
		...
		<tr>
                ...
                <TD  height="23">
                <% if(userprofile.getUSPNameLast().length() > 2 ){ %>
                	<bean:write name="individualForm" property="namelast"/>
                <% }else{ %>
...
<% if(! (userprofile.getUSPAgree1Fg().length() > 0)  && true==false ){ %>
	<tr>     
        <TD height="30" >
