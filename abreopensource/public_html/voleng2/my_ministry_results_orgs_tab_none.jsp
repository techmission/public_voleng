...
<div id="breadcrumbs"><a href="<%=request.getContextPath()%>/register.do?method=showHome">home</a> &gt; <a href="<%=request.getContextPath()%>/search.jsp">volunteer</a> &gt; opportunities search results  </div>
	</div>
<% } %>
			...
			<input type="hidden" name="method" value="processOrgSearchAll">
			  ...
			  <table width="300" border="0" cellpadding="0" cellspacing="5" style="font-size: 12px;">
			    <tr>
			      ...
			      <td><input name="postalcode" type="text" id="postalcodeorgsrch" style="width:60px;" /></td>
			      <td><strong>Distance</strong></td>
			      <td><select id="distanceorgsrch" name="distance" style="width:80px; z-index: -1">
...
<button type="button" id="submitButton" onclick="orgsrch_search()">Search</button>
<% }else{ %>
<input type="image" name="imageField" src="http://www.christianvolunteering.org/imgs/button_search_clr.gif" border="0" width="59" height="24" />
<% } %>
			      </td>
			    </tr>
			  </table>
