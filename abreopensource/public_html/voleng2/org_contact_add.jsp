...
<% }else{ %>
  ...
  <div id="oppsearch">
	<% if(bAdminRole==true){ %>
	  <span id="title">Add Organization Contact for <bean:write name='orgForm' property='orgname' /></span>
	<% }else{ %>
	  <span id="title">Add Organization Contact</span>
	<% } %>
...
<div id="pagebanner">
	<% if(bAdminRole==true){ %>
  <span style="float: left;">Add Organization Contact for <bean:write name='orgForm' property='orgname' /></span>
	<% }else{ %>
  <span style="float: left;">Add Organization Contact</span>
	<% } %>
...
<h3>Add Existing User as Contact:</h3><br>     
...
<form name="orgForm" action="<%=aszPortal%>/org.do<%if(aszPortal.length()>0){%>?method=addNewOrgContact<%}%>" >
<input type="hidden" name="method" value="addNewOrgContact" />
...
<br><br>
<b>OR...</b>
<br><br><h3>Add a Brand New Contact:</h3><br>
<!--
...
<form method="post" name="orgForm" action="<%=aszPortal%>/org.do<%if(aszPortal.length()>0){%>?method=addBrandNewOrgContact<%}%>" >
<input type="hidden" name="method" value="addBrandNewOrgContact" />
<input type="hidden" name="subdomain" value="<%=aszSubdomain%>" />
