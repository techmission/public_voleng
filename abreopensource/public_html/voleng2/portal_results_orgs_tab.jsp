...
<% }else{ %>
<td colspan=2><input type="button" name="modalDialog" value="Add to My <%=aszOrgOrChurch%> Listings" onClick="submitForm()"></td>
<% } %>
<td width="20"></td>
<td>
Sort results by: </td>
...
<% if(bAssoc==true){ %>
<input type="hidden" name="requesttype" id="requesttype" value="natlassoc" >
<% } %>
