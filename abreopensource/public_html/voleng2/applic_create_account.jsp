...
<form name="individualForm" action="<%=aszPortal%>/register.do<%if(aszPortal.length()>0){%>?method=processCreateAccountCVIntern<%}%>" focus="username" target="_self" method="post">
<input type="hidden" name="method" value="processCreateAccountCVIntern" />
