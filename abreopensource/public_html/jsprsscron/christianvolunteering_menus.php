...
$myFile = "christianvolunteering_menus.htm";
...
/* rdsmith 2008.02.04   1746EST  */
		...
		$sr3 = new search_replace('http://www.christianvolunteering.org', '', array('christianvolunteering_menus.htm'));
        $sr3->set_search_function('quick');
        $sr3->do_search();  
		
		$sr4 = new search_replace('/churchvolunteer.jsp', 'http://www.christianvolunteering.org/churchvolunteer.jsp', array('christianvolunteering_menus.htm'));
