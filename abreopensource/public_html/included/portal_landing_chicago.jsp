...
$(document).ready(function() {
	...
	$('#search_input').find('a:first').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:opportunity&fq=location:%22Chicago,%20IL%22');
	$('#search_input').find('a:last').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:organization&fq=location:%22Chicago,%20IL%22');
});
</script>
...
<div id="params" style="display:none;">
	...
	<div id="keyword_search">city_tax:"Chicago, IL"</div>
	<div id="fq_search">city_tax:"Chicago, IL"</div>
		...
		<ul id="position_type" class="tagcloud toggle comma" style="display:block;"></ul>
			...
			<p>
              <ul>
                ...
                <li><a href="/oppsrch.do?method=processSolrSearch#fq=city_tax:%22Los%20Angeles,%20CA%22&fq=content_type:opportunity">Los Angeles</a></li>
                <li><a href="/oppsrch.do?method=processSolrSearch#fq=city_tax:%22New%20York%22&fq=content_type:opportunity">New York City</a></li>
