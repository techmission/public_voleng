...
$(document).ready(function() {
	$('#queryLoc').val('Denver, CO');
	$('#search_input').find('a:first').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:opportunity&fq=city_tax:%22Denver,%20CO%22');
	$('#search_input').find('a:last').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:organization&fq=city_tax:%22Denver,%20CO%22');
});
</script>
...
<div id="params" style="display:none;">
	...
	<div id="keyword_search">city_tax:"Denver, CO"</div>
	<div id="fq_search">city_tax:"Denver, CO"</div>
...
<div id="welcomebox" class="wide landingpage">
	<div style="float:left;"> <!-- img can have maximum width of about 485px; -->
		<img src="<%=aszPortal%>/imgs_denver/denvernight.jpg" width="414" height="228" alt="Search short-term missions trips and volunteer opportunities in the Chicago area! Find opportunities in urban ministry, Christian internships, and church volunteering."  >
	</div>
