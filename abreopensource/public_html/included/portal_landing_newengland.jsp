...
$(document).ready(function() {
	$('#queryLoc').val('Boston, MA');
    $('#search_input').find('a:first').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:opportunity&fq=location:%22Boston,%20MA%22');
	$('#search_input').find('a:last').attr('href', '/oppsrch.do?method=processSolrSearch#fq=content_type:organization&fq=location:%22Boston,%20MA%22');
});
</script>
...
<div id="params" style="display:none;">
	...
	<div id="keyword_search">city_tax:"Boston, MA"</div>
	<div id="fq_search">city_tax:"Boston, MA"</div>
...
<div id="welcomebox" class="wide landingpage">
	<div style="float:left;"> <!-- img can have maximum width of about 485px; -->
		<img src="<%=aszPortal%>/imgs/boston-main-pic.jpg" width="414" height="228" alt="Search short-term missions trips and volunteer opportunities in the Chicago area! Find opportunities in urban ministry, Christian internships, and church volunteering."  >
	</div>
