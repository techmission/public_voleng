...
<title>Technology in Christian Missions Volunteer Opportunity Search: ChristianVolunteering.org</title>
<meta name="keyword" content="technology in missions, Christian technology, Christian computer, christian volunteer, short term missions, missions trips, Christian, church, Christian volunteering, Christian volunteer, church volunteer, orphanage, medical missions, christian internship, ministry internship, community, service, urban ministry, youth, social justice, missions, missionary, virtual volunteer, online volunteering, volunteer online, TechMission, CCDA, UYWI, Salvation Army, City Union Mission, Gospel Mission, World Vision" />
<meta name="description" content="Search thousands of technology in missions trips and volunteer opportunities! Find opportunities in information technology, computers, programming and engineering." />
...
String aszLandingParamsHash = "fq=service_areas:%22Computers / Technology%22";//fq=position_type:%22Short-term Missions / Volunteer Internship%22
String aszLandingParamsURL = "sa/Computers_|_Technology"; // /pt/Short-term_Missions_|_Volunteer_Internship

aszLandingParamsURL="oppsrch.do?method=processSearch&"+aszLandingParamsHash;
%>
...
$(document).ready(function() {
	...
	$('input#query').val("Computers / Technology - (Service Area)");
	
	$('#search_input').find('a:first').attr('href', '/<%=aszLandingParamsURL%>&fq=content_type:opportunity#<%=aszLandingParamsHash%>&fq=content_type:opportunity');
	$('#search_input').find('a:first').html('Browse Technology in Missions Opportunities');
	
	$('#search_input').find('a:last').attr('href', '/<%=aszLandingParamsURL%>&fq=content_type:organization#<%=aszLandingParamsHash%>&fq=content_type:organization');
	$('#search_input').find('a:last').html('Browse Technology in Missions Organizations');
...
<div id="welcomebox" class="wide landingpage">
	<div style="float:left;"> <!-- img can have maximum width of about 485px; -->
		<img src="<%=aszPortal%>/imgs/pic/walking.jpg" alt="Search thousands of technology in missions trips and volunteer opportunities! Find opportunities in information technology, computers, programming and engineering."  width="417" height="234" />
	</div>
...
<%@ include file="/template_include/directory_page_facet_links.inc" %>
	...
	<div id="midbox1" class="landingpage">
		...
		<div id="midbox1_content"><!-- style="height: 400px;"-->
			<br>
			<h2 class="head"><p>Technology Opportunities by Interest</p></h2>
			<p>
						...
						<logic:notEmpty name="facetlist" >
							...
							%>
									<span <%=aszDisplayClass%>>
										<a href="<%=aszPortal%>/<%=aszLandingParamsURL%>&fq=<%=aszFacets0%>:<%=aszFacets1%>&content_type:opportunity#<%=aszLandingParamsHash%>&fq=<%=facets[0]%>:&quot;<%=facets[1].replaceAll("&", "%26")%>&quot;&fq=content_type:opportunity"><%=facets[1]%> (<%=facets[2]%>)</a>,&nbsp;
									</span>	
	...
	<div id="midbox2" class="landingpage">
		...
		<div id="midbox2_content"><!-- style="height: 400px;"-->
			<br/>
			<h2 class="head"><p>Technology Opportunities by Location</p></h2>
	...
	<div id="midbox3" class="landingpage">
		...
		<div id="midbox3_content"><!-- style="height: 400px;"-->
			<br/>
			<h2 class="head"><p>Technology Organizations</p></h2>
			<p>
...
<div id="params" style="display:none;">
	...
	<div id="keyword_search">service_areas:"Computers and Technology" OR "Tech: Graphics/Web/IT Ministry"</div>
	<div id="fq_search">service_areas:"Computers and Technology" OR "Tech: Graphics/Web/IT Ministry"</div>
