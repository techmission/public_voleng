...
<title>Volunteer in a Christian Orphanage: ChristianVolunteering.org</title>
<meta name="keywords" content="orphanage volunteer, christian orphanage, orphanage mission trips, christian volunteer, short term missions, missions trips, Christian, church, Christian volunteering, Christian volunteer, church volunteer, orphanage, medical missions, christian internship, ministry internship, community, service, urban ministry, youth, social justice, missions, missionary, virtual volunteer, online volunteering, volunteer online, TechMission, CCDA, UYWI, Salvation Army, City Union Mission, Gospel Mission, World Vision" />
<meta name="description" content="Search thousands of orphanage missions trips and volunteer opportunities! Christianvolunteering.org is the largest directory of volunteer opportunities in Christian orphanages in the world." />
...
String aszLandingParamsURL = "sa/Orphanage/pt/Short-term_Missions_|_Volunteer_Internship";
String aszLandingParamsHash = "fq=position_type:%22Short-term Missions / Volunteer Internship%22&fq=service_areas:%22Orphanage%22";
%>

<script language="javascript">
$(document).ready(function() {
	$('#srchmethod').val('Short-term Missions / Volunteer Internship');
	$('input#query').val("Orphanage - (Service Area)");
	...
	$('#search_input').find('a:first').html('Browse Orphanage Volunteer Opportunities');
	...
	$('#search_input').find('a:last').html('Browse Orphanage Organizations');
...
<div id="welcomebox" class="wide landingpage">
	<div style="float:left;"> <!-- img can have maximum width of about 485px; -->
		<img src="<%=aszPortal%>/imgs/pic/walking.jpg" alt="Search thousands of orphanage missions trips and volunteer opportunities! Christianvolunteering.org is the largest directory of volunteer opportunities in Christian orphanages in the world."  width="417" height="234" />
	</div>
...
<%@ include file="/template_include/directory_page_facet_links.inc" %>
	...
	<div id="midbox1" class="landingpage">
		...
		<div id="midbox1_content"><!-- style="height: 400px;"-->
			<br>
			<h2 class="head"><p>Orphanage Volunteer Opportunities by Interest</p></h2>
			<p>
	...
	<div id="midbox2" class="landingpage">
		...
		<div id="midbox2_content"><!-- style="height: 400px;"-->
			<br/>
			<h2 class="head"><p>Orphanage Volunteer Opportunities by Location</p></h2>
	...
	<div id="midbox3" class="landingpage">
		...
		<div id="midbox3_content"><!-- style="height: 400px;"-->
			<br/>
			<h2 class="head"><p>Orphanage Organizations</p></h2>
			<p>
				<li class="filter handle expanded landingpage" id="facet_primary_opp_type">
					<a class="handle" onClick="toggle_display('primary_opp_type')"><span class="label">Orphanages By Focus:</span></a>
            ...
            <p>
				<li class="filter handle expanded landingpage" id="facet_org_affil">
					<a class="handle" onClick="toggle_display('org_affil')"><span class="label">Orphanages By Affiliation:</span></a>
            ...
            <p>
				<li class="filter handle expanded landingpage" id="facet_country_tax2">
					<a class="handle" onClick="toggle_display('country_tax')"><span class="label">Orphanages By Country:</span></a>
            ...
            <p>
				<li class="filter handle expanded landingpage" id="facet_region2">
					<a class="handle" onClick="toggle_display('region')"><span class="label">Orphanages By Region:</span></a>
...
<div id="params" style="display:none;">
	...
	<div id="keyword_search">service_areas:"Orphanage"</div>
	<div id="fq_search">service_areas:"Orphanage"</div>
