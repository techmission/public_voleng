...
//console.log('name is '+name+';  index is '+index);	
//console.log('name is '+name+';  this.params[name] is '+this.params[name]);	
  ...
  exposedString: function () {
    ...
    for (var i = 0, l = this.exposed.length; i < l; i++) {
	  ...
	  // make sure {!pt=42.2826027%2C-71.06760500000001 sfield=latlng d=40.2336} does not get appended somehow
            new_param=decodeURIComponent(this.params[this.exposed[i]][j].string());
			if(new_param.indexOf('fq={!pt=') != -1){
			  var geo_index = new_param.indexOf('{!geofilt');
			  new_param = 'fq=' + new_param.substr(geo_index);
			}
	  ...
	  // make sure {!pt=42.2826027%2C-71.06760500000001 sfield=latlng d=40.2336} does not get appended somehow
          new_param=decodeURIComponent(this.params[this.exposed[i]].string());
			if(new_param.indexOf('fq={!pt=') != -1){
			  var geo_index = new_param.indexOf('{!geofilt');
			  new_param = 'fq=' + new_param.substr(geo_index);
			}
