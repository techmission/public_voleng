...
(function ($) {
  ...
  $(function () {
//console.log('hostname is: ' + document.location.hostname);
...
//console.log('proxyUrl is: ' + proxyUrl);
	...
	var fields = [ 'position_type', 'service_areas', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'org_member_type', 'org_name' ];
	...
	Manager.addWidget(new AjaxSolr.SearchWithAutocompleteWidget({
	  ...
	  target: '#search',
	  field: 'keywords',
	  fields: [ 'service_areas', 'great_for', 'benefits_offered', 'trip_length', 'service_areas_search', 'skills_search', 'benefits_offered_search', 'org_affil', 'denom_affil', 'org_member_type', 'title', 'org_name' ],
...
var params = {
  facet: true,
  'facet.field': [ 'position_type', 'service_areas', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'org_member_type',  'org_name' ],
  'facet.limit': 100,
  'facet.mincount': 1,
