...
//      proxyUrl: 'http://www.christianvolunteering.org/search/proxy.php'
	...
	var fields = [ 'position_type', 'service_areas', 'skills', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'city_tax', 'primary_opp_type', 'org_member_type' ];
	for (var i = 0, l = fields.length; i < l; i++) {
	  field_div_variant = fields[i];
	  ...
	  for(var j=0; j<4; j++){
		  var field_div = field_div_variant + j;
//console.log('field_div is '+ field_div+' ');
			  if($('#'+field_div)!=null){
				  Manager.addWidget(new AjaxSolr.FacetsWidget({
					id: field_div,
					target: '#' + field_div,
...
// console.log('field_div '+ field_div+' is null');
			  }
	  }
	}
...
var params = {
  facet: true,
  'facet.field': [ 'position_type', 'service_areas', 'skills', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'city_tax', 'primary_opp_type', 'org_member_type' ],
  'facet.limit': 100,
  'facet.mincount': 1,
