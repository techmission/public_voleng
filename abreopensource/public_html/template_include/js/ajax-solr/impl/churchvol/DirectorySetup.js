...
(function ($) {
  ...
  $(function () {
	...
	if(results_type=='organization'){
		...
		fields = [ 'primary_opp_type', 'service_areas', 'skills', 'great_for', 'trip_length', 'country_tax', 'region', 'province_tax', 'city_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'org_member_type' ];
	}else{
		fields = [ 'position_type', 'service_areas', 'skills', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'city_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'org_member_type' ];
	}
...
var params = {
  facet: true,
  'facet.field': [ 'position_type', 'service_areas', 'skills', 'great_for', 'frequency', 'benefits_offered', 'trip_length', 'country_tax', 'region', 'province_tax', 'denom_affil', 'org_affil', 'id', 'source', 'country', 'city_tax', 'org_member_type' ],
  'facet.limit': 100,
  'facet.mincount': 1,
