...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
  ...
  clickHandler: function (page) {
    var self = this;
    return function () {
      self.manager.store.get('start').val((page - 1) * (self.manager.response.responseHeader.params && self.manager.response.responseHeader.params.rows || 20));
console.log('PagerWidget.js doRequest line 187');
