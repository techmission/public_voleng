...
<form id="initialRegistration" method="get" name="initialRegistration" action="http://www.churchvolunteering.org<%=aszPortal%>/register.do"?>
...
<a href="http://www.churchvolunteering.org/<%=aszPortal%>/individualregistration.jsp">
...
<form id="churchsearch" name="churchsearch"  method="get" action="http://www.churchvolunteering.org<%=aszPortal%>/oppsrch.do">
