    ...
    **/
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if(null == session) {
            ...
            Enumeration aEnumTmp = session.getAttributeNames();
            if( null != aEnumTmp ){
                while ( aEnumTmp.hasMoreElements() ) {
                    String aszName = (String) aEnumTmp.nextElement() ;
            ...
            aEnumTmp = request.getHeaderNames() ;
            if( null != aEnumTmp ){
                while ( aEnumTmp.hasMoreElements() ) {
                    String aszName = (String) aEnumTmp.nextElement() ;
                    if( null == aszName ) continue ; 
            ...
            if( null != aServletContext ){
                aEnumTmp = aServletContext.getAttributeNames();
                if( null != aEnumTmp ){
                    while ( aEnumTmp.hasMoreElements() ) {
                        String aszName = (String) aEnumTmp.nextElement() ;
                        if( null == aszName ) continue ; 
